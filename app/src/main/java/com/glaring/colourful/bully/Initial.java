...
public class Initial extends Activity implements OnClickListener{
	...
	public void onClick(View v) {
		...
		if (v.getId() == R.id.newgamebtn) {
			...
			Intent intent = new Intent("com.glaring.colourful.bully.ABOUT"); 
			startActivity(intent);
		}
		else if (v.getId()==R.id.statisticsbtn) {
			Intent intent = new Intent("com.glaring.colourful.bully.STATISTICS"); 
			startActivity(intent);
		}
			...
			Intent intent = new Intent("com.glaring.colourful.bully.PREFERENCES"); 
			startActivity(intent);
		}		
		else if (v.getId()==R.id.share) {
			Intent intent = new Intent("com.glaring.colourful.bully.SHARE"); 
			startActivity(intent);
		}
